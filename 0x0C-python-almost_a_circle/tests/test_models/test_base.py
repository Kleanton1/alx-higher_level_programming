    ...
    def setUpClass(cls):
        ...
        def test_pep8_conformance_base(self):
            ...
            def test_pep8_conformance_test_base(self):
                ...
                pep8style = pep8.StyleGuide(quiet=True)
                result = pep8style.check_files(['test/test_models/test_base.py'])
                self.assertEqual(result.total_errors, 0,
                                 "Found code style errors (and warnings).")
                                            ...
                                            def test_no_id(self):
                                                ...
                                                def test_id_set(self):
                                                    ...
                                                    def test_no_id_after_set(self):
                                                        """Tests id as None after not N one"""
                                                        b2 = Base()
                                                                        ...
                                                                        def test_empty_to_json_string(self):
                                                                            ...
                                                                            def test_None_to_json_String(self):
                                                                                ...
                                                                                def test_from_json_string(self):
                                                                                    ...
                                                                                    json_1 = Base.from_json_string(json_str)
                                                                                    self.assertTrue(type(json_1) is list)
                                                                                    self.assertEqual(len(json_1), 2)
                                                                                    self.assertTrue(type(json_1[0] is dict)
                                                                                                    self.assertTrue(type(json_1[1] is dict)
